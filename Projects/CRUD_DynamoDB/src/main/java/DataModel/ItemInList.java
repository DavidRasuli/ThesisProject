...
public class ItemInList {
	...
	public boolean isAvailable() {
		return available;
	} //TODO : Rename - maybe collected or checked
	...
	public ItemInList cloneItemInList(String newListId)
	{
		ItemInList itemInList = new ItemInList(newListId,this.itemId,this.measureVolume,this.measureUnit,false,false,null,this.name);
		itemInList.setComments(this.comments);
		itemInList.setImageUrls(this.imageUrls);
